...
export const projects = [
  {
    id: 1,
    name: "Text2Json",
    description: "A cli app built in go that converts.txt filesinto .json",
    technologies: ["Go", "CLI"],
  },
  {
    id: 2,
    name: "Implementation of an AI-Driven Load Forecasting System: Ensuring Reliable Power for the University of Lagos",
    description:
      "Built Three models namely Support Vector Machine, Artificial Neural Network, Random Forest and trained them with data from the university's power station to forecast the electricity demand in a short period",
